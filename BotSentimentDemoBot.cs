...
namespace BotSentimentDemo
{
    ...
    public class BotSentimentDemoBot : IBot
    {
        ...
        public BotSentimentDemoBot(ConversationState conversationState, ILoggerFactory loggerFactory, ITextAnalyticsClient analyticsClient)
        {
            ...
            _accessors = new BotSentimentDemoAccessors(conversationState)
            {
                CounterState = conversationState.CreateProperty<CounterState>(BotSentimentDemoAccessors.CounterStateName),
            };
